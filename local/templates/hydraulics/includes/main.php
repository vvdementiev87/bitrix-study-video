                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-9">
                        <div class="slide-item__content">
                            <h1 class="slide-item__subtitle">High Quality Construction Solutions For Residentials &
                                Industries!
                            </h1>
                            <h2 class="slide-item__title">Provide Effective Building Solutions!</h2>
                            <p class="slide-item__desc">A leading developer of A-grade commercial, industrial and
                                residential
                                projects
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 px-0 features-wrapper d-flex flex-wrap">
                ...
                <div class="feature-item">
                    <div class="feature-item__content">
                        ...
                        <p class="feature-item__desc">Facilities meet high security requirements and are certified to
                            the
                ...
                <div class="feature-item">
                    <div class="feature-item__content">
                        ...
                        <p class="feature-item__desc">International supply chains involves of unknown risks and
                            challenging
                            regulations.</p>
                        <a href="#" class="btn btn__link btn__secondary"><i class="icon-arrow-right"></i></a>
                    </div><!-- /.feature-content -->
                ...
                <div class="feature-item">
                    <div class="feature-item__content">
                        ...
                        <p class="feature-item__desc">Utilising latest processing solutions, and decades of work
                            experience.</p>
                        <a href="#" class="btn btn__link btn__secondary"><i class="icon-arrow-right"></i></a>
                    </div><!-- /.feature-content -->
                </div><!-- /.col-lg-3 -->
                ...
                <div class="feature-item bg-theme">
                    <div class="slick-carousel m-slides-0"
                        ...
                        <div class="feature-item__content">
                            ...
                            <p class="feature-item__desc color-white mb-0">Complete control over products allows us to
                                ensure our
                                customers receive
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-6">
                <div class="about-img-container">
                    <div class="about-img">
                        <img src="<?= SITE_TEMPLATE_PATH; ?>/images/about/1.jpg" alt="about" class="img-fluid">
                    </div><!-- /.about-img -->
                    <div class="about-img">
                        <img src="<?= SITE_TEMPLATE_PATH; ?>/images/about/2.jpg" alt="about" class="img-fluid">
                    </div><!-- /.about-img -->
                </div>
                <div class="video-box">
            ...
            <div class="col-sm-12 col-md-12 col-lg-6">
                <div class="text-container heading-layout2">
                    <h3 class="heading__title">Ready to Bring Bigger, Better, Faster & Stronger Projects Than
                        Ever!!</h3>
                    <p class="heading__desc mt-30 mb-30">Amarou is a representative Industrial Construction operator
                        providing full range of service in the sphere of Civil Construction & Mechanical Engineering
                        worldwide
                    ...
                    <p class="heading__desc mb-30">Yet those that embrace change are thriving, building bigger, better,
                        faster, and
                        stronger products than ever before. You are helping lead the charge; we can help you build on
                        your past
...
<section class="services-layout2 pb-90">
    <div class="bg-img"><img src="<?= SITE_TEMPLATE_PATH; ?>/images/backgrounds/3.jpg" alt="banner"></div>
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-6">
                <p class="heading__desc color-dark font-weight-bold mb-50">QA leading developer of A-grade commercial,
                    ...
                    projects in USA. Since its foundation the company has doubled its turnover year on year with its
                    staff.
                </p>
            </div><!-- /.col-lg-6 -->
        </div><!-- /.row -->
                ...
                <div class="slick-carousel"
                    ...
                    <div class="service-item">
                        <div class="service-item__content">
                            ...
                            <p class="service-item__desc">Architecture is both the process and the product of planning,
                                and
                                constructing
                    ...
                    <div class="service-item">
                        <div class="service-item__content">
                            ...
                            <p class="service-item__desc">Given the increasing complexity of many construction projects
                                it is
                                becoming
                    ...
                    <div class="service-item">
                        <div class="service-item__content">
                            ...
                            <p class="service-item__desc">Professional service uses specialized, project management
                                techniques to
                                oversee
                    ...
                    <div class="service-item">
                        <div class="service-item__content">
                            ...
                            <p class="service-item__desc">When it comes to choosing a renovator to transform the
                                interior of your
                                home,
                    ...
                    <div class="service-item">
                        <div class="service-item__content">
                            ...
                            <p class="service-item__desc">Design build is project delivery in which one entity works
                                under a
                                single
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-6 col-sm-4 col-md-2 col-lg-2">
                <div class="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/1.png" alt="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/1.png" alt="client">
                </div><!-- /.client -->
            </div><!-- /.col-lg-2 -->
            <div class="col-6 col-sm-4 col-md-2 col-lg-2">
                <div class="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/2.png" alt="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/2.png" alt="client">
                </div><!-- /.client -->
            </div><!-- /.col-lg-2 -->
            <div class="col-6 col-sm-4 col-md-2 col-lg-2">
                <div class="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/3.png" alt="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/3.png" alt="client">
                </div><!-- /.client -->
            </div><!-- /.col-lg-2 -->
            <div class="col-6 col-sm-4 col-md-2 col-lg-2">
                <div class="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/4.png" alt="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/4.png" alt="client">
                </div><!-- /.client -->
            </div><!-- /.col-lg-2 -->
            <div class="col-6 col-sm-4 col-md-2 col-lg-2">
                <div class="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/5.png" alt="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/5.png" alt="client">
                </div><!-- /.client -->
            </div><!-- /.col-lg-2 -->
            <div class="col-6 col-sm-4 col-md-2 col-lg-2">
                <div class="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/6.png" alt="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/6.png" alt="client">
                </div><!-- /.client -->
            </div><!-- /.col-lg-2 -->
            <div class="col-6 col-sm-4 col-md-2 col-lg-2">
                <div class="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/7.png" alt="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/7.png" alt="client">
                </div><!-- /.client -->
            </div><!-- /.col-lg-2 -->
            <div class="col-6 col-sm-4 col-md-2 col-lg-2">
                <div class="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/8.png" alt="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/8.png" alt="client">
                </div><!-- /.client -->
            </div><!-- /.col-lg-2 -->
            <div class="col-6 col-sm-4 col-md-2 col-lg-2">
                <div class="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/9.png" alt="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/9.png" alt="client">
                </div><!-- /.client -->
            </div><!-- /.col-lg-2 -->
            <div class="col-6 col-sm-4 col-md-2 col-lg-2">
                <div class="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/10.png" alt="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/10.png" alt="client">
                </div><!-- /.client -->
            </div><!-- /.col-lg-2 -->
            <div class="col-6 col-sm-4 col-md-2 col-lg-2">
                <div class="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/11.png" alt="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/11.png" alt="client">
                </div><!-- /.client -->
            </div><!-- /.col-lg-2 -->
            <div class="col-6 col-sm-4 col-md-2 col-lg-2">
                <div class="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/12.png" alt="client">
                    <img src="<?= SITE_TEMPLATE_PATH; ?>/images/clients/12.png" alt="client">
                </div><!-- /.client -->
            </div><!-- /.col-lg-2 -->
        </div><!-- /.row -->
    ...
    <div class="container-fluid col-padding-0">
        <div class="row align-items-center">
            <div class="col-sm-12 col-md-12 col-lg-5">
                <div class="banner-panel">
                    <div class="heading-layout2 mb-40">
                        ...
                        <p class="heading__desc">Yet those that embrace change are thriving, building bigger, better,
                            faster,
                            and stronger products than ever before. You are helping lead the charge; we can help you
                            build on your
            ...
            <div class="col-sm-12 col-md-12 col-lg-7">
                <img src="<?= SITE_TEMPLATE_PATH; ?>/images/banners/3.jpg" alt="banner" class="w-100">
            </div><!-- /.col-lg-6 -->
        </div><!-- /.row -->
    </div><!-- /.container -->
                ...
                <div class="slick-carousel"
                    ...
                    <div class="portfolio-item">
                        <div class="portfolio-item__img">
                            <a class="popup-gallery-item" href="<?= SITE_TEMPLATE_PATH; ?>/images/portfolio/grid/1.jpg">
                                <img src="<?= SITE_TEMPLATE_PATH; ?>/images/portfolio/grid/1.jpg" alt="portfolio img">
                            </a>
                        </div><!-- /.portfolio-img -->
                        <div class="portfolio-item__content">
                            ...
                            <h4 class="portfolio-item__title"><a href="projects-single-project.html">The Fallingwater
                                    House</a>
                            </h4>
                            <p class="portfolio-item__desc">We understand that data is greatest asset when it comes to
                                analyzing
                                and
                    ...
                    <div class="portfolio-item">
                        <div class="portfolio-item__img">
                            <a class="popup-gallery-item" href="<?= SITE_TEMPLATE_PATH; ?>/images/portfolio/grid/2.jpg">
                                <img src="<?= SITE_TEMPLATE_PATH; ?>/images/portfolio/grid/2.jpg" alt="portfolio img">
                            </a>
                        </div><!-- /.portfolio-img -->
                        <div class="portfolio-item__content">
                            <div class="portfolio-item__cat">
                            ...
                            <h4 class="portfolio-item__title"><a href="projects-single-project.html">The Guggenheim
                                    Museum</a>
                            </h4>
                            <p class="portfolio-item__desc">Cost savings is crucial, innovative technology minimizes
                                your overall
                                spend
                    ...
                    <div class="portfolio-item">
                        <div class="portfolio-item__img">
                            <a class="popup-gallery-item" href="<?= SITE_TEMPLATE_PATH; ?>/images/portfolio/grid/3.jpg">
                                <img src="<?= SITE_TEMPLATE_PATH; ?>/images/portfolio/grid/3.jpg" alt="portfolio img">
                            </a>
                        </div><!-- /.portfolio-img -->
                        <div class="portfolio-item__content">
                            <div class="portfolio-item__cat">
                            ...
                            <h4 class="portfolio-item__title"><a href="projects-single-project.html">Neue National
                                    Galerie</a>
                            </h4>
                            <p class="portfolio-item__desc">Our Group has been building relationships and projects last.
                                Serving
                                an
                    ...
                    <div class="portfolio-item">
                        <div class="portfolio-item__img">
                            <a class="popup-gallery-item" href="<?= SITE_TEMPLATE_PATH; ?>/images/portfolio/grid/4.jpg">
                                <img src="<?= SITE_TEMPLATE_PATH; ?>/images/portfolio/grid/4.jpg" alt="portfolio img">
                            </a>
                        </div><!-- /.portfolio-img -->
                        <div class="portfolio-item__content">
                            <div class="portfolio-item__cat">
                            ...
                            <h4 class="portfolio-item__title"><a href="projects-single-project.html">Sagrada Familia</a>
                            </h4>
                            <p class="portfolio-item__desc">Cost savings is crucial, innovative technology minimizes
                                your overall
                                spend
                    ...
                    <div class="portfolio-item">
                        <div class="portfolio-item__img">
                            <a class="popup-gallery-item" href="<?= SITE_TEMPLATE_PATH; ?>/images/portfolio/grid/5.jpg">
                                <img src="<?= SITE_TEMPLATE_PATH; ?>/images/portfolio/grid/5.jpg" alt="portfolio img">
                            </a>
                        </div><!-- /.portfolio-img -->
                        <div class="portfolio-item__content">
                            <div class="portfolio-item__cat">
                            ...
                            <h4 class="portfolio-item__title"><a href="projects-single-project.html">Heydar Aliyev
                                    Center</a></h4>
                            <p class="portfolio-item__desc">Our Group has been building relationships and projects last.
                                Serving
                                an
                    ...
                    <div class="portfolio-item">
                        <div class="portfolio-item__img">
                            <a class="popup-gallery-item" href="<?= SITE_TEMPLATE_PATH; ?>/images/portfolio/grid/6.jpg">
                                <img src="<?= SITE_TEMPLATE_PATH; ?>/images/portfolio/grid/6.jpg" alt="portfolio img">
                            </a>
                        </div><!-- /.portfolio-img -->
                        <div class="portfolio-item__content">
                            <div class="portfolio-item__cat">
                            ...
                            <h4 class="portfolio-item__title"><a href="projects-single-project.html">Cathedral of
                                    Brasilia</a>
                            </h4>
                            <p class="portfolio-item__desc">We understand that data is greatest asset when it comes to
                                analyzing
...
<section class="banner-layout4 bg-overlay bg-parallax">
    <div class="bg-img"><img src="<?= SITE_TEMPLATE_PATH; ?>/images/banners/4.jpg" alt="background"></div>
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-5">
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4">
                        <div class="fancybox-item">
                            ...
                            <div class="fancybox-item__content">
                                ...
                                <p class="fancybox-item__desc">Building projects impressive list of long-term
                                    clients.</p>
                            </div><!-- /.fancybox-content -->
                        </div><!-- /.fancybox-item -->
                    </div><!-- /.col-lg-4 -->
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4">
                        <div class="fancybox-item">
                            ...
                            <div class="fancybox-item__content">
                                ...
                                <p class="fancybox-item__desc">Involves of unknown risks and challenging
                                    regulations.</p>
                            </div><!-- /.fancybox-content -->
                        </div><!-- /.fancybox-item -->
                    </div><!-- /.col-lg-4 -->
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4">
                        <div class="fancybox-item">
                            ...
                            <div class="fancybox-item__content">
                                ...
                                <p class="fancybox-item__desc">Take great pride in everything that we do in our
                                    Company.</p>
                            </div><!-- /.fancybox-content -->
                        </div><!-- /.fancybox-item -->
                    </div><!-- /.col-lg-44 -->
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4">
                        <div class="fancybox-item">
                            ...
                            <div class="fancybox-item__content">
                                ...
                                <p class="fancybox-item__desc">Recognized as one of World's leading Construction
                                    firms.</p>
                            </div><!-- /.fancybox-content -->
                        </div><!-- /.fancybox-item -->
                    </div><!-- /.col-lg-4 -->
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4">
                        <div class="fancybox-item">
                            ...
                            <div class="fancybox-item__content">
                                ...
                                <p class="fancybox-item__desc">Bring bigger, better, faster and stronger projects than
                                    ever.</p>
                            </div><!-- /.fancybox-content -->
                        </div><!-- /.fancybox-item -->
                    </div><!-- /.col-lg-4 -->
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="contact-panel mt--130">
                    <div class="testimonials testimonials-layout1 bg-overlay bg-overlay-theme">
                        <div class="bg-img">
                            <img src="<?= SITE_TEMPLATE_PATH; ?>/images/banners/6.jpg" alt="banner">
                        </div>
                        <div class="slick-carousel"
                            ...
                            <div class="testimonial-item">
                                ...
                                <p class="testimonial-item__desc">They are the expertly trained team members who take
                                    extra step and
                                    go the extra mile, to fulfill our promise to deliver dynamic solutions to our
                                    customers to fit
                                    needs of a rapidly changing global environment!!
                                </p>
                                <div class="testimonial-item__meta">
                                    <div class="testimonial-item__thumb">
                                        <img src="<?= SITE_TEMPLATE_PATH; ?>/images/testimonials/thumbs/1.jpg"
                                             alt="author thumb">
                            ...
                            <div class="testimonial-item">
                                ...
                                <div class="testimonial-item__meta">
                                    <div class="testimonial-item__thumb">
                                        <img src="<?= SITE_TEMPLATE_PATH; ?>/images/testimonials/thumbs/2.jpg"
                                             alt="author thumb">
                                    </div><!-- /.testimonial-thumb -->
                                    <div>
                            ...
                            <div class="testimonial-item">
                                ...
                                <div class="testimonial-item__meta">
                                    <div class="testimonial-item__thumb">
                                        <img src="<?= SITE_TEMPLATE_PATH; ?>/images/testimonials/thumbs/3.jpg"
                                             alt="author thumb">
                                    </div><!-- /.testimonial-thumb -->
                                    <div>
                                        <h4 class="testimonial-item__meta-title">John Peter</h4>
                    ...
                    <form method="post" action="<?= SITE_TEMPLATE_PATH; ?>/php/contact.php" id="contactForm"
                          class="contact-panel__form">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="contact-panel__title">Request A Quote</h4>
                                <p class="contact-panel__desc mb-40">We take great pride in everything that we do,
                                    complete control
...
<section class="counters-layout2">
    <div class="bg-img"><img src="<?= SITE_TEMPLATE_PATH; ?>/images/backgrounds/2.jpg" alt="background"></div>
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-8">
                <div class="heading-layout3 mb-70">
                    <h2 class="heading__subtitle">Work With All The Major Industry Suppliers</h2>
                    <h3 class="heading__title">Committed To Delivering High Quality Construction Projects And Innovate
                        Design!
                    </h3>
                </div><!-- /.heading -->
            </div><!-- /.col-lg-8 -->
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-3 col-lg-3">
                ...
                <hr>
                <p>Yet those that embrace change are thriving, building bigger, better, faster, and stronger products
                    than
                    ever.</p>
            ...
            <div class="col-sm-6 col-md-3 col-lg-3">
                ...
                <hr>
                <p>You are helping lead the charge; we can help you build on your past and prepare future changing
                    faster.
                </p>
                <ul class="list-items list-items-layout2 list-unstyled">
            ...
            <div class="col-sm-6 col-md-3 col-lg-3">
                ...
                <hr>
                <p>Industrial Construction operator providing full range of service in the sphere of Civil
                    Construction.</p>
                <ul class="list-items list-items-layout2 list-unstyled">
            ...
            <div class="col-sm-6 col-md-3 col-lg-3">
                ...
                <hr>
                <p>Since its foundation the company has doubled its turnover year on year with our experienced
                    staff.</p>
                <ul class="list-items list-items-layout2 list-unstyled">
...
<section class="banner-layout1 py-0 has-top-gray">
    <div class="container-fluid col-padding-0">
        <div class="row align-items-center">
            <div class="col-sm-12 col-md-12 col-lg-7">
                <img src="<?= SITE_TEMPLATE_PATH; ?>/images/banners/1.jpg" alt="banner" class="w-100">
            </div><!-- /.col-lg-6 -->
            <div class="col-sm-12 col-md-12 col-lg-5">
                <div class="banner-panel">
        ...
        <div class="row">
                ...
                <div class="post-item">
                    <div class="post-item__img">
                        <a href="blog-single-post.html">
                            <img src="<?= SITE_TEMPLATE_PATH; ?>/images/blog/grid/4.jpg" alt="blog image">
                        </a>
                    </div><!-- /.blog-img -->
                    <div class="post-item__content">
                        ...
                        <h4 class="post-item__title"><a href="blog-single-post.html">Importers achieve cost savings
                                through the
                                First Sale rule!</a>
                        </h4>
                        <p class="post-item__desc">The trade war currently ensuing between the US and several nations
                            around the
                            globe, most fiercely with China, shows no signs of the first set of tariffs levied against
                            solar...
                        </p>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="post-item">
                    <div class="post-item__img">
                        <a href="blog-single-post.html">
                            <img src="<?= SITE_TEMPLATE_PATH; ?>/images/blog/grid/5.jpg" alt="blog image">
                        </a>
                    </div><!-- /.blog-img -->
                    <div class="post-item__content">
                        <div class="post-item__meta d-flex flex-wrap align-items-center">
                        ...
                        <h4 class="post-item__title"><a href="blog-single-post.html">Cargo flow through better supply
                                chain
                                visibility, control.</a>
                        </h4>
                        <p class="post-item__desc">Global provider connected products for consumers, and enterprises
                            worldwide,
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="post-item">
                    <div class="post-item__img">
                        <a href="blog-single-post.html">
                            <img src="<?= SITE_TEMPLATE_PATH; ?>/images/blog/grid/6.jpg" alt="blog image">
                        </a>
                    </div><!-- /.blog-img -->
                    <div class="post-item__content">
                        <div class="post-item__meta d-flex flex-wrap align-items-center">
                        ...
                        <p class="post-item__desc">Our team provides highly skilled & experienced portfolio managers who
                            know
                            the
            ...
            <div class="col-sm-12 col-md-12 col-lg-4 offset-lg-8">
                <div class="contact-panel__info bg-white">
                        ...
                        <ul class="contact-panel__block__list list-unstyled">
                            <li><? $APPLICATION->IncludeComponent(
                                    ...
                                    array(
                                        ...
                                        "EDIT_TEMPLATE" => "",
                                        "PATH" => SITE_TEMPLATE_PATH . "/includes/adress_footer.php"
                                    )
                                ); ?></li>
                        </ul>
                    ...
                    <div class="contact-panel__block">
                        ...
                        <ul class="contact-panel__block__list list-unstyled">
                            <li><a href="mailto:Amarou@7oroof.com"></a>Email: <? $APPLICATION->IncludeComponent(
                                    "bitrix:main.include",
                                    "",
                                    array(
                                        "AREA_FILE_SHOW" => "file",
                                        "AREA_FILE_SUFFIX" => "inc",
                                        "EDIT_TEMPLATE" => "",
                                        "PATH" => SITE_TEMPLATE_PATH . "/includes/contact_email.php"
                                    )
                                ); ?></li>
                            <li><a href="tel:01061245741"></a>Call Us: <? $APPLICATION->IncludeComponent(
                                    "bitrix:main.include",
                                    "",
                                    array(
                                        "AREA_FILE_SHOW" => "file",
                                        "AREA_FILE_SUFFIX" => "inc",
                                        "EDIT_TEMPLATE" => "",
                                        "PATH" => SITE_TEMPLATE_PATH . "/includes/contact_phone_footer.php"
                                    )
                                ); ?></li>
                        </ul>
                    </div><!-- /.contact-panel__info__block -->
                        ...
                        <ul class="contact-panel__block__list list-unstyled">
                            <li><? $APPLICATION->IncludeComponent(
                                    ...
                                    array(
                                        ...
                                        "AREA_FILE_SUFFIX" => "inc",
                                        "EDIT_TEMPLATE" => "",
                                        "PATH" => SITE_TEMPLATE_PATH . "/includes/contact_workdays_footer.php"
                                    )
                                ); ?></li>
                            <li><? $APPLICATION->IncludeComponent(
                                    "bitrix:main.include",
                                    ...
                                    array(
                                        ...
                                        "AREA_FILE_SUFFIX" => "inc",
                                        "EDIT_TEMPLATE" => "",
                                        "PATH" => SITE_TEMPLATE_PATH . "/includes/contact_workhours_footer.php"
                                    )
                                ); ?></li>
                        </ul>
                    </div><!-- /.contact-panel__info__block -->
